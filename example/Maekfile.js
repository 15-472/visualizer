...
const test_math_O0_obj = maek.CPP('test-math.cpp', maek.options.objPrefix + 'test-math_O0', {CPPFlags:['-O0', '-DREPORT_PREFIX="O0."']});
const test_math_O2_obj = maek.CPP('test-math.cpp', maek.options.objPrefix + 'test-math_O2', {CPPFlags:['-O2', '-DREPORT_PREFIX="O2."']});
const test_math_O0_exe = maek.LINK([test_math_O0_obj], 'bin/test-math_O0');
const test_math_O2_exe = maek.LINK([test_math_O2_obj], 'bin/test-math_O2');

maek.TARGETS = [test_math_O0_exe, test_math_O2_exe];
